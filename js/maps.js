...
function initMap() {
  ...
  function success(pos) {
    ...
    tbTiendas.AgregaRegistro(0, 'PROMOACTIVADOR', '', 38, 'PROMOACTIVADOR', '', 16, 'ZONA 16', 666666, 'EDGAR ALFREDO GARCIA ALAVEZ', 19.304738, -99.203846, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/moto.png');
    tbTiendas.AgregaRegistro(1, 'CHEDRAUI', '../img/Autoservicios/Chedraui.png', 38, 'CHEDRAUI', '../img/Autoservicios/Chedraui.png', 16, 'ZONA 16', 380042, 'TUXTEPEC', 18.091860, -96.131017, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/chedraui.png');
    tbTiendas.AgregaRegistro(1, 'CHEDRAUI', '../img/Autoservicios/Chedraui.png', 38, 'CHEDRAUI', '../img/Autoservicios/Chedraui.png', 29, 'ZONA 29', 380234, 'AJUSCO', 19.298832, -99.211610, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/chedraui.png');
    tbTiendas.AgregaRegistro(2, 'WALMART', '../img/Autoservicios/Walmart.png', 44, 'BODEGA AURRERA', '../img/Autoservicios/BodegaAurrera.png', 16, 'ZONA 16', 441180, 'TUXTEPEC - OAXACA', 18.090689, -96.133418, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/bodegaaurrera.png');
    tbTiendas.AgregaRegistro(2, 'WALMART', '../img/Autoservicios/Walmart.png', 74, 'SAMS', '../img/Autoservicios/Sams.png', 16, 'ZONA 16', 746277, 'SAMS TUXTEPEC', 18.091146, -96.132068, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/sams.png');
    tbTiendas.AgregaRegistro(3, 'SORIANA', '../img/Autoservicios/Soriana.png', 17, 'HIPERMERCADO Y SUPER', '../img/Autoservicios/HiperMercado.png', 29, 'ZONA 29', 170937, 'Mega Soriana Coapa', 19.294811, -99.156600, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/soriana.png');
    tbTiendas.AgregaRegistro(4, 'COMERCIAL MEXICANA', '../img/Autoservicios/ComercialMexicana.png', 43, 'MEGA COMERCIAL', '../img/Autoservicios/MegaComercial.png', 29, 'ZONA 29', 430174, 'MEGA COAPA', 19.302624, -99.207281, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/superama.png');
    tbTiendas.AgregaRegistro(19, 'CITY FRESKCO', '../img/Autoservicios/CityFresko.png', 53, 'CITY FRESKO', '../img/Autoservicios/CityFresko.png', 29, 'ZONA 29', 530017, 'LA COMER TLALPAN', 19.306876, -99.164759, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/soriana.png');
    tbTiendas.AgregaRegistro(42, 'SUBURBIA', '../img/Autoservicios/Suburbia.png', 29, 'SUBURBIA', '../img/Autoservicios/Suburbia.png', 29, 'ZONA 29', 290496, 'Villa Coapa', 19.295872, -99.155254, 'https://raw.githubusercontent.com/OthonCC/portalpwa/master/img/superama.png');
